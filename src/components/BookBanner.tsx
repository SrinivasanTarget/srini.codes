...
import { latestBook } from '../portfolio/books'

const BookBanner: React.FC = () => {
  const location = useLocation()

  // Don't show on the books page itself
    ...
    >
      <div className='max-w-7xl mx-auto px-4 sm:px-6 py-2.5 flex items-center justify-center gap-2 sm:gap-3'>
        ...
        >
          ...
          <span className='text-xs sm:text-sm text-white/90 font-medium'>{latestBook.title}</span>
